...
class YtDlp(TaskListener):
    ...
    async def new_event(self):
        ...
        self.youtube_upload_mode = self.user_dict.get("YT_DEFAULT_FOLDER_MODE", "playlist")
        ...
        if self.up_dest and self.up_dest.startswith("yt:"):
            ...
            parts = self.up_dest.split(":", 6)[1:] # Skip 'yt' prefix, max 6 parts for overrides
            ...
            if len(parts) > 1 and parts[1]:
                if parts[1] in ["playlist", "individual", "playlist_and_individual"]:
                    ...
                    LOGGER.warning(f"Invalid YouTube mode override '{parts[1]}' in -up. Ignoring mode override.")
