...
FILELION_API = ""
STREAMWISH_API = ""
EXCLUDED_EXTENSIONS = "" # Space separated file extensions to exclude (e.g., .log .exe)
INCOMPLETE_TASK_NOTIFIER = False # Notify for incomplete tasks on restart (requires DATABASE_URL)
...
# Update
UPSTREAM_REPO = "https://github.com/AeonOrg/Aeon-MLTB" # Upstream repository for updates
...
HYBRID_LEECH = False # Switch between bot/user session based on file size (Premium only)
